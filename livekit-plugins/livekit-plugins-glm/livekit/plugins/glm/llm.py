...
class LLM(llm.LLM):
    def __init__(
        self,
        *,
        model: str | ChatModels = "glm-4-flash",
        ...
        """
        Create a new instance of GLM LLM.

        ``api_key`` must be set to your GLM API key, either using the argument or by setting the
        ``GLM_API_KEY`` environmental variable.
        """
        super().__init__()
